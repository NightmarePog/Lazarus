...
--------------------------------------------------------------------
-- Generated by the Laze compiler v1.0 (self-hosted)
...
function StmtParser.parse_object_member(self)
    ...
    -- StmtParser:174
    return StmtParser.parse_object_member_decl(self, visibility)
end
-- StmtParser:177
...
function StmtParser.parse_member(self, visibility)
    -- StmtParser:388
    return StmtParser.parse_member_decl(self, visibility)
end
-- StmtParser:391
...
function StmtParser.parse_static(self)
    -- StmtParser:413
    return StmtParser.parse_static_decl(self)
end
-- StmtParser:416
...
function MetaEmitter.emit(class_name, sig)
    ...
    local nl = Text.nl()
    -- MetaEmitter:27
    return ((("--[[LAZE_META" .. nl) .. MetaEmitter.sig_json(class_name, sig)) .. nl) .. "]]"
end
-- MetaEmitter:30
...
function Linker.load_prebuilt(self, path, origin_source, origin_line, origin_col, origin_span)
    ...
    if Option.is_none(sig_opt) then
        -- Linker:137
        Error.new("LinkError", ("prebuilt library '" .. path) .. "' has no LAZE_META block", origin_line, origin_col, origin_source, origin_span):raise()
    end
    -- Linker:139
    local class_name = Path.stem(path)
    -- Linker:140
...
function Main.new()
    ...
    if Option.is_some(path) then
        ...
        -- Main:77
        Error.new("NoFileAppended", "No file appended, use 'lazec <FILE.laz>'", 0, 0, "", 2):raise()
    end
    return self
end
-- Main:84
