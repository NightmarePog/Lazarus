...
describe("Functions", function()
    describe("parser", function()
        ...
        it("reads 'static name' without '(' as a member, not a method", function()
            -- A method is `name(...) { }`; without the `(` this is a static member
    ...
    describe("schematic", function()
        ...
        it("accepts an outer static member referenced in the body", function()
            assert.has_no.errors(
                function() analyze("private static k = 2\nstatic f() { return k }") end
            )
        end)
    ...
    describe("codegen", function()
        it(
            "emits a no-parameter function as a static method",
            function()
                assert.equal(
                    "function Main.f()\n    return 0\nend",
        ...
        it(
            "emits an empty body",
            function() assert.equal("function Main.noop()\nend", members("static noop() {}")) end
        )
        ...
        it(
            "indents a nested function as a local function",
            function()
                assert.equal(
...
describe("Function calls", function()
    ...
    describe("schematic", function()
        ...
        it("accepts a call inside a function body", function()
            assert.has_no.errors(
                function() analyze("static id(a) { return a }\nstatic use(a) { return id(a) }") end
            )
        end)
    ...
    describe("codegen", function()
        it(
            "emits a no-argument call, qualifying the member callee",
            function()
                assert.equal(
                    "function Main.f()\n    return 0\nend\nMain.f()",
                    members("static f() { return 0 }\nf()")
